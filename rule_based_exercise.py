...
df = pd.read_csv("C:\\Users\\Estesia\\PycharmProjects\\datasets\\persona.csv")
...
agg_df = agg_df.reset_index().rename(columns={"AGE": "AGE", "COUNTRY": "COUNTRY", "SOURCE": "SOURCE", "SEX": "SEX"})
...
agg_df["CUSTOMERS_LEVEL_BASED"] = ["_".join([country, source, age, age_cat]).upper()
