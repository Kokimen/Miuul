...
with st.expander("1 - Ben Kimim?"):
    ...
    st.write("Hem Product Marketing Manager görevine, hem de aylardır bilgiler öğrendiğim insanın açtığı pozisyona başvurmaktan heyecan duyuyorum. Geçmişimdeki pazarlama "
             "deneyimim ve ""miuul ailesinden aldığım veri eğitimleri sayesinde, ekibinize değerli katkılar sağlayabileceğime eminim.")
